...
import { useFeaturedProducts, useFeaturedProductsServer } from "@/components/hooks/useProducts"
...
import { ProductsQuery } from "@/lib/types/shopify"
...
const ProductCarousel = () => {
  ...
  const { data: productsData, isLoading: productsLoading } = useFeaturedProductsServer(
    { first: 8 },
  )
